...
<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
	...
	<table class="form-table" role="presentation">
		<tbody>
			<tr>
				<th scope="row">
					<label for="cf7aic_provider"><?php esc_html_e( 'Provider', 'olmbox-ai-inbox-for-contact-form-7' ); ?></label>
				</th>
				<td>
			...
			<tr>
				<th scope="row">
					<label for="cf7aic_api_key"><?php esc_html_e( 'API Key', 'olmbox-ai-inbox-for-contact-form-7' ); ?></label>
				</th>
				<td>
					<input
						type="password"
						...
						class="regular-text"
						autocomplete="off"
						placeholder="<?php echo esc_attr( $has_api_key ? __( 'Leave blank to keep the current key', 'olmbox-ai-inbox-for-contact-form-7' ) : __( 'Enter your API key', 'olmbox-ai-inbox-for-contact-form-7' ) ); ?>"
					/>
					<p class="description">
						<?php if ( $has_api_key ) : ?>
							<?php
							printf(
								...
								esc_html__( 'Currently set: %s', 'olmbox-ai-inbox-for-contact-form-7' ),
								esc_html( $masked_key )
							);
							?>
						<?php else : ?>
							<?php esc_html_e( 'No API key has been set yet. AI features stay off until one is saved here.', 'olmbox-ai-inbox-for-contact-form-7' ); ?>
						<?php endif; ?>
					</p>
				</td>
			</tr>
			<tr>
				<th scope="row">
					<label for="cf7aic_model"><?php esc_html_e( 'Model', 'olmbox-ai-inbox-for-contact-form-7' ); ?></label>
				</th>
				<td>
					<div class="cf7aic-model-row">
						...
						>
							...
							<?php else : ?>
								<option value=""><?php esc_html_e( '— Load models to choose one —', 'olmbox-ai-inbox-for-contact-form-7' ); ?></option>
							<?php endif; ?>
						</select>
						<button
							type="button"
						...
						>
							<?php esc_html_e( 'Load Models', 'olmbox-ai-inbox-for-contact-form-7' ); ?>
						</button>
					</div>
...
<p>
	<button type="button" id="cf7aic-test-connection" class="button">
		<?php esc_html_e( 'Test Connection', 'olmbox-ai-inbox-for-contact-form-7' ); ?>
	</button>
