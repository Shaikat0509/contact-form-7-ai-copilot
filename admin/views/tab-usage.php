...
?>
<p class="description">
	<?php esc_html_e( 'These figures are purely informational — there is no cap on AI analysis. It always runs as long as an API key is configured.', 'olmbox-ai-inbox-for-contact-form-7' ); ?>
</p>
<div class="cf7aic-stats-grid">
	...
	<div class="cf7aic-stat-card">
		<span class="cf7aic-stat-card__label"><?php esc_html_e( 'Provider', 'olmbox-ai-inbox-for-contact-form-7' ); ?></span>
		<span class="cf7aic-stat-card__value"><?php echo esc_html( $provider_label ); ?></span>
	</div>
	<div class="cf7aic-stat-card">
		<span class="cf7aic-stat-card__label"><?php esc_html_e( 'Model', 'olmbox-ai-inbox-for-contact-form-7' ); ?></span>
		<span class="cf7aic-stat-card__value"><?php echo esc_html( '' !== $provider_settings['model'] ? $provider_settings['model'] : '—' ); ?></span>
	</div>
	<div class="cf7aic-stat-card">
		<span class="cf7aic-stat-card__label"><?php esc_html_e( 'Count Resets On', 'olmbox-ai-inbox-for-contact-form-7' ); ?></span>
		<span class="cf7aic-stat-card__value"><?php echo esc_html( $usage_tracker->get_reset_date() ); ?></span>
	</div>
	<div class="cf7aic-stat-card">
		<span class="cf7aic-stat-card__label"><?php esc_html_e( 'Estimated Token Usage', 'olmbox-ai-inbox-for-contact-form-7' ); ?></span>
