...
final class AdminPage {
	...
	public function render(): void {
		if ( ! current_user_can( Menu::CAPABILITY ) ) {
			wp_die( esc_html__( 'You do not have permission to access this page.', 'cf7-ai-copilot' ) );
		}
	...
	private function render_sidebar( string $section, string $settings_tab ): void {
		...
		<aside class="cf7aic-sidebar">
			<div class="cf7aic-sidebar__brand">
				...
				<span class="cf7aic-sidebar__brand-text"><?php esc_html_e( 'AI Copilot', 'cf7-ai-copilot' ); ?></span>
			</div>

			<nav class="cf7aic-sidebar__nav" aria-label="<?php esc_attr_e( 'AI Copilot sections', 'cf7-ai-copilot' ); ?>">
				<a
				...
				>
					...
					<?php esc_html_e( 'Dashboard', 'cf7-ai-copilot' ); ?>
				</a>
				...
				>
					...
					<?php esc_html_e( 'AI Inbox', 'cf7-ai-copilot' ); ?>
				...
				<details class="cf7aic-sidebar__group" <?php echo 'settings' === $section ? 'open' : ''; ?>>
					<summary class="cf7aic-sidebar__item cf7aic-sidebar__item--group <?php echo 'settings' === $section ? 'cf7aic-sidebar__item--active' : ''; ?>">
						...
						<?php esc_html_e( 'Settings', 'cf7-ai-copilot' ); ?>
					</summary>
			...
			<div class="cf7aic-sidebar__footer">
				<a
					...
					href="https://wordpress.org/support/plugin/cf7-ai-copilot/reviews/#new-post"
					target="_blank"
					rel="noopener noreferrer"
				>
					<span class="dashicons dashicons-star-filled" aria-hidden="true"></span>
					<?php esc_html_e( 'Rate Us', 'cf7-ai-copilot' ); ?>
				</a>
				...
				<details class="cf7aic-sidebar__user">
					...
					<div class="cf7aic-sidebar__user-menu">
						<a href="<?php echo esc_url( get_edit_profile_url( $user->ID ) ); ?>"><?php esc_html_e( 'Edit Profile', 'cf7-ai-copilot' ); ?></a>
						<a href="<?php echo esc_url( wp_logout_url( Menu::url() ) ); ?>"><?php esc_html_e( 'Log Out', 'cf7-ai-copilot' ); ?></a>
					</div>
				</details>
			</div>
		</aside>
	...
	private function get_title_and_subtitle( string $section, int $submission_id, string $settings_tab ): array {
		if ( 'dashboard' === $section ) {
			return array(
				__( 'Dashboard', 'cf7-ai-copilot' ),
				__( 'An overview of your AI Copilot activity.', 'cf7-ai-copilot' ),
			);
		}

		if ( 'submissions' === $section && $submission_id > 0 ) {
			return array( __( 'Submission Review', 'cf7-ai-copilot' ), '' );
		}

		if ( 'submissions' === $section ) {
			return array(
				__( 'AI Inbox', 'cf7-ai-copilot' ),
				__( 'Review AI-drafted summaries and suggested replies before anything is sent.', 'cf7-ai-copilot' ),
			);
		}
	...
	private function render_saved_notice(): void {
		...
		printf(
			...
			esc_html__( 'Settings saved.', 'cf7-ai-copilot' )
		);
	}
}
